...
/* -----------------------------------------------------------
   CUSTOM CURSOR WITH AURORA TRAIL + STARS (Purple Theme)
----------------------------------------------------------- */
          ...
          >
            {isStar ? (
              <div
                className="w-8 h-8"
                style={{
                  background: `radial-gradient(circle, rgba(255, 255, 255, ${opacity}) 0%, rgba(168, 85, 247, ${opacity * 0.7}) 30%, transparent 50%)`, // Purple tint
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle,
                    rgba(168, 85, 247, ${opacity}) 0%,
                    rgba(139, 92, 246, ${opacity * 0.9}) 25%,
                    rgba(192, 132, 252, ${opacity * 0.8}) 50%,
                    rgba(147, 51, 234, ${opacity * 0.7}) 75%,
                    transparent 100%)`,
                  filter: "blur(16px)",
                }}
              />
      ...
      >
        ...
        <div className="relative w-6 h-6 -translate-x-1/2 -translate-y-1/2">
          ...
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="absolute top-1/2 left-1/2 w-1 h-3 bg-gradient-to-t from-purple-400 to-purple-500"
              style={{
...
function FloatingParticles() {
  ...
  for (let i = 0; i < particleCount; i++) {
    ...
    // Vary particle sizes - some big, some small
